...
export const metadata: Metadata = {
  metadataBase: new URL("https://viannusamandiri.id"),
  title: {
    default:
      "PT Vian Nusa Mandiri - Kontraktor Konstruksi & Perawatan Gedung Profesional Jakarta",
    template: "%s | PT Vian Nusa Mandiri",
  },
  description:
    "PT Vian Nusa Mandiri adalah perusahaan konstruksi dan jasa perawatan gedung terpercaya di Jakarta. Melayani konstruksi, building maintenance, dan pengadaan barang untuk korporasi dan instansi pemerintah dengan standar profesional.",
  keywords: [
    "kontraktor Jakarta",
  ...
  openGraph: {
    title:
      "PT Vian Nusa Mandiri - Kontraktor Konstruksi & Perawatan Gedung Profesional",
    description:
      "Perusahaan konstruksi dan jasa perawatan gedung terpercaya. Melayani korporasi dan instansi pemerintah dengan standar profesional tinggi.",
  ...
  twitter: {
    ...
    description:
      "Jasa konstruksi, perawatan gedung, dan pengadaan barang untuk korporasi dan pemerintah.",
  ...
  other: {
    "business:contact_data:street_address":
      process.env.COMPANY_ADDRESS || "Jalan Raya Jakarta",
    ...
    "business:contact_data:phone_number":
      process.env.COMPANY_PHONE || "+62-21-XXXX-XXXX",
    "business:contact_data:website":
      process.env.NEXT_PUBLIC_SITE_URL || "https://viannusamandiri.com",
  },
};
