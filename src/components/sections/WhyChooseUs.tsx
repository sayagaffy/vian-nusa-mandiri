...
import { Shield, Clock, Users, Zap, Award, HeartHandshake, CheckCircle, FileText } from 'lucide-react'
...
export default function WhyChooseUs() {
  const advantages = [
    {
      ...
      description: "Didukung oleh tim ahli dengan pengalaman bertahun-tahun di industri konstruksi dan building maintenance",
      highlight: "15+ Profesional"
    },
    {
      icon: <Shield className="w-8 h-8" />,
      title: "Komitmen Kualitas Tinggi",
      description: "Setiap proyek dikerjakan dengan standar kualitas tertinggi dan pengawasan ketat di setiap tahapan",
      highlight: "Quality First"
    },
    {
      icon: <Clock className="w-8 h-8" />,
      title: "Responsif & Tepat Waktu",
      description: "Respon cepat 24 jam dan komitmen menyelesaikan proyek sesuai timeline yang disepakati",
      highlight: "24/7 Support"
    },
    {
      icon: <Users className="w-8 h-8" />,
      title: "Layanan Personal",
      description: "Setiap klien mendapat perhatian khusus dengan project manager dedicated untuk setiap proyek",
      highlight: "Dedicated PM"
    },
    {
      icon: <Award className="w-8 h-8" />,
      title: "Harga Transparan",
      description: "Tidak ada biaya tersembunyi dengan penawaran harga yang kompetitif dan transparan",
      highlight: "No Hidden Cost"
    },
    {
      icon: <HeartHandshake className="w-8 h-8" />,
      title: "Garansi Pekerjaan",
      description: "Memberikan garansi pekerjaan dan layanan purna jual untuk memastikan kepuasan jangka panjang",
  ...
  return (
    <section id="keunggulan" className="bg-gradient-to-br from-gray-50 to-white section-padding">
      <div className="mx-auto px-6 container">
        {/* Header */}
        <div className="mb-16 text-center">
          <h2 className="section-title">Mengapa Memilih PT Vian Nusa Mandiri?</h2>
          <p className="mx-auto max-w-3xl section-subtitle">
            Komitmen profesionalisme dan kualitas tinggi dalam setiap proyek yang kami tangani
          </p>
        </div>
        ...
        <div className="gap-8 grid md:grid-cols-2 lg:grid-cols-3 mb-16">
          {advantages.map((advantage, index) => (
            <div key={index} className="group bg-white shadow-sm hover:shadow-xl p-8 border border-gray-100 rounded-xl transition-all duration-300">
        ...
        <div className="gap-8 grid lg:grid-cols-2 mb-16">
          ...
          <div className="bg-white shadow-sm p-8 border border-gray-100 rounded-2xl">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h3 className="font-bold text-gray-900 text-xl">Legalitas Perusahaan</h3>
                <p className="text-gray-600">Dokumen legal lengkap dan terkini</p>
              </div>
            </div>
          ...
          <div className="bg-white shadow-sm p-8 border border-gray-100 rounded-2xl">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h3 className="font-bold text-gray-900 text-xl">Sertifikasi Industri</h3>
                <p className="text-gray-600">Proses sertifikasi berkelanjutan</p>
              </div>
            </div>
              ...
              {certifications.map((cert, index) => (
                <div key={index} className="flex justify-between items-center bg-gray-50 p-4 rounded-lg">
                  <div className="flex items-center">
                    ...
                    <div>
                      <span className="block font-medium text-gray-900">{cert.name}</span>
                      <span className="text-gray-500 text-sm">Target: {cert.timeline}</span>
                    </div>
                  </div>
            ...
            <div className="bg-blue-50 mt-6 p-4 rounded-lg">
              <p className="text-blue-800 text-sm">
                <strong>Update:</strong> Semua sertifikasi dalam tahap penyelesaian untuk memastikan compliance penuh dengan standar industri konstruksi Indonesia.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white shadow-sm p-12 border border-gray-100 rounded-2xl text-center">
          ...
          <p className="mx-auto mb-8 max-w-2xl text-gray-600 text-lg">
            Konsultasi gratis untuk memahami kebutuhan spesifik proyek Anda. 
