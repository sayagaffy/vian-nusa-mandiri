    ...
    <section className="relative flex items-center bg-gradient-to-br from-blue-50 via-white to-blue-50 min-h-screen">
      <div className="items-center gap-12 grid lg:grid-cols-2 mx-auto px-6 container">
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="max-w-2xl text-gray-600 text-xl leading-relaxed">
              PT Vian Nusa Mandiri hadir dengan semangat baru dan komitmen tinggi untuk memberikan 
              solusi konstruksi dan building maintenance berkualitas internasional.
            </p>
          </div>
          ...
          <div className="gap-6 grid md:grid-cols-2">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h3 className="font-semibold text-gray-900">Legalitas Lengkap</h3>
                <p className="text-gray-600 text-sm">SIUP, NIB, dan dokumen legal terkini</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">Komitmen timeline yang disepakati</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h3 className="font-semibold text-gray-900">Tim Berpengalaman</h3>
                <p className="text-gray-600 text-sm">Profesional dengan track record solid</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">Kualitas premium dengan budget efisien</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex sm:flex-row flex-col gap-4">
            <button className="flex justify-center items-center bg-blue-600 hover:bg-blue-700 shadow-lg px-8 py-4 rounded-lg font-semibold text-white transition-colors">
              Konsultasi Gratis
          ...
          <div className="flex items-center space-x-4 pt-4">
            <div className="flex -space-x-2">
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="flex justify-center items-center bg-blue-100 border-2 border-white rounded-full w-10 h-10">
                  <Users className="w-5 h-5 text-blue-600" />
                </div>
              ))}
            </div>
            <div>
              <div className="font-medium text-gray-900 text-sm">Dipercaya Klien Korporasi</div>
              <div className="text-gray-600 text-xs">Startup hingga Enterprise</div>
            </div>
          </div>
        </div>
        ...
        <div className="relative">
          ...
          <div className="z-10 relative bg-white shadow-2xl p-8 rounded-2xl">
            <div className="flex justify-center items-center bg-gradient-to-br from-blue-50 to-blue-100 mb-6 rounded-lg aspect-video">
              <div className="text-blue-600 text-center">
                <Shield className="mx-auto mb-4 w-16 h-16" />
                <h3 className="mb-2 font-bold text-lg">Proyek Unggulan</h3>
                <p className="text-sm">Renovasi Kantor Modern</p>
                <div className="bg-blue-600 mt-4 px-4 py-2 rounded-full font-medium text-white text-sm">
                  Sedang Berlangsung
                </div>
              </div>
            </div>
      ...
      <div className="bottom-0 left-0 absolute w-full">
        <svg viewBox="0 0 1200 120" fill="none" className="w-full h-24">
          <path d="M0,64L48,69.3C96,75,192,85,288,80C384,75,480,53,576,48C672,43,768,53,864,64C960,75,1056,85,1152,85.3L1200,85.3L1200,120L1152,120C1056,120,960,120,864,120C768,120,672,120,576,120C480,120,384,120,288,120C192,120,96,120,48,120L0,120Z" fill="white"/>
        </svg>
      </div>
    </section>
  )
